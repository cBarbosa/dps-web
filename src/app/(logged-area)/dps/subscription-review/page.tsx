...
import { getReviewProposals } from '../actions';
...
export default async function Page({
    ...
    const dataRaw = await getReviewProposals(
            token,
            undefined,
            currentPage
    );
        ...
        <div className="p-5">
			<div className="p-5 w-full max-w-7xl mx-auto bg-white rounded-3xl">
				<div className="flex justify-start items-center gap-6 mt-2 mb-7">
					<h2 className="text-xl text-primary">Painel de Revisão</h2>
					<span className="text-muted-foreground text-sm">
						Aqui listamos as DPS&apos;s que aguardam revisão.
					</span>
				</div>

...
export default async function Page({
    ...
    console.log('Saler-sup-cancel page - Verificação de permissão:', {
        granted,
    ...
    if (!granted) {
        console.log('Saler-sup-cancel page - Redirecionando para dashboard - permissão negada');
        redirect('/dashboard');
    }
    ...
    console.log('Saler-sup-cancel page - Dados recebidos:', {
        hasData: !!dataRaw,
